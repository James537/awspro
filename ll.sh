...
beikong7_chushihua(){
    echo "开启秒级更新"
    wget https://raw.githubusercontent.com/James537/awspro/master/second.sh -O /root/.awsll/second.sh
	wget https://raw.githubusercontent.com/James537/awspro/master/refresh.sh -O /root/.awsll/refresh.sh
...
beikong9_chushihua(){
    echo "卸载管理脚本"
	wget https://raw.githubusercontent.com/James537/awspro/master/unaws.sh
    chmod +x unaws.sh
	bash unaws.sh
    }
