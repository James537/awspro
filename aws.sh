...
beikong0_chushihua(){
		...
		vnstat -u -i eth0
		mkdir /root/.awsll/
		wget https://raw.githubusercontent.com/James537/awspro/master/vnstat.sh -O /root/.awsll/vnstat.sh
		chmod +x /root/.awsll/vnstat.sh
		wget https://raw.githubusercontent.com/James537/awspro/master/awsoff.sh -O /root/.awsll/awsoff.sh
		chmod +x /root/.awsll/awsoff.sh
		
	read -p "是否下载1T版本脚本[y/N]" down_files_1
	if [[ "$down_files_1" =~ ^[yY]$ ]]; then
		echo "正在下载1T版脚本"
		wget https://raw.githubusercontent.com/James537/awspro/master/aws1024.py -O /root/.awsll/aws1024.py
    ...
    echo "正在添加自启任务"
    wget https://raw.githubusercontent.com/James537/awspro/master/aws1024-zq.sh -O /root/.awsll/aws1024-zq.sh
    chmod +x /root/.awsll/aws1024-zq.sh
	chmod +x /etc/rc.d/rc.local
	echo "/root/.awsll/aws1024-zq.sh >/root/.awsll/aws1024.py.log 2>&1" >> /etc/rc.d/rc.local
	echo "正在下载管理脚本"
    curl -o /usr/bin/aws -Ls https://raw.githubusercontent.com/James537/awspro/master/ll.sh
	chmod +x /usr/bin/aws
...
beikong1_chushihua(){
    echo "开始安装依赖"
		...
		vnstat -u -i eth0
		mkdir /root/.awsll/
		wget https://raw.githubusercontent.com/James537James537/awspro/master/vnstat.sh -O /root/.awsll/vnstat.sh
		chmod +x /root/.awsll/vnstat.sh
		wget https://raw.githubusercontent.com/James537/awspro/master/awsoff.sh -O /root/.awsll/awsoff.sh
		chmod +x /root/.awsll/awsoff.sh
	...
	if [[ "$down_files_1" =~ ^[yY]$ ]]; then
		echo "正在下载2T版脚本"
		wget https://raw.githubusercontent.com/James537/awspro/master/aws2048.py -O /root/.awsll/aws2048.py
    ...
    cron_config=$(crontab -l | grep "vnstat.sh")
    echo "正在添加自启任务"
    wget https://raw.githubusercontent.com/James537/awspro/master/aws2048-zq.sh -O /root/.awsll/aws2048-zq.sh
...
beikong2_chushihua(){
	...
	if [[ "$down_files_1" =~ ^[yY]$ ]]; then
		echo "正在下载5G版脚本"
		wget https://raw.githubusercontent.com/James537/awspro/master/aws5.py -O /root/.awsll/aws5.py
    ...
    cron_config=$(crontab -l | grep "vnstat.sh")
    echo "正在添加自启任务"
    wget https://raw.githubusercontent.com/James537/awspro/master/aws5-zq.sh -O /root/.awsll/aws5-zq.sh
